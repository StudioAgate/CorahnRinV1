<?php
	...
	*******************************************************************************/
	...
	function AddFont($family, $style='', $file='', $uni=false)
	{
		...
		if ($uni) {
			if (defined('P_FPDF_SYSTEM_TTF_FONTS') && file_exists(P_FPDF_SYSTEM_TTF_FONTS.$file )) { pr('ok'); $ttffilename = P_FPDF_SYSTEM_TTF_FONTS.$file ; }
			elseif (file_exists($file)) { $ttffilename = $file; }
