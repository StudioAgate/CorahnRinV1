...
class Encoding
{
    ...
    public static function toWin1252($text)
    {
        ...
        if (is_string($text)) {
            return utf8_decode(
                str_replace(array_keys(self::$utf8ToWin1252), self::$utf8ToWin1252, self::toUTF8($text))
            );
        }
    ...
    public static function fixUTF8($text)
    {
        ...
        while ($last <> $text) {
            $last = $text;
            $text = self::toUTF8(
                utf8_decode(str_replace(array_keys(self::$utf8ToWin1252), self::$utf8ToWin1252, $text))
            );
        }
        $text = self::toUTF8(
            utf8_decode(str_replace(array_keys(self::$utf8ToWin1252), self::$utf8ToWin1252, $text))
    ...
    public static function UTF8FixWin1252Chars($text)
    {
        ...
        return str_replace(array_keys(self::$brokenUtf8ToUtf8), self::$brokenUtf8ToUtf8, $text);
    }
